...
interface HistoireConstruireProps {
  title: string;
...
/** Section « Ce qui manquait, j'ai décidé de le construire » — texte à gauche, image à droite. */
export function HistoireConstruire({
  title,
  titleHighlight,
  paragraph1,
  paragraph2,
